...
{
    const SERVICE_PROVIDERS_DUMP_FILENAME = 'framework/cache/service-providers-%s.php';
...
DOC;
    ...
    */
    ...
    {
        $providersDump = storage_path(sprintf(self::SERVICE_PROVIDERS_DUMP_FILENAME, $env));
